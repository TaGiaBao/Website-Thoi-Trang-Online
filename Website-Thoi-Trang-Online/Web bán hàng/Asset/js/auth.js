...
// Pages/admin/* needs two-level up ('../../'), Pages/* needs one-level up ('../')
const apiBase = window.location.pathname.includes('/Pages/admin/') ? '../../' : (window.location.pathname.includes('/Pages/') ? '../' : '');
